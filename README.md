...
## Walk-through the Elm Architecture and Syntax [Ellie Link](https://ellie-app.com/cJThH7q7Ja1/0)
...
## Change from `beginnerProgram` to `Program` [Ellie Link](https://ellie-app.com/cJThH7q7Ja1/1)
...
## Get a Random Int and Render it [Ellie Link](https://ellie-app.com/cJThH7q7Ja1/2)
...
## Create an Array of Responses [Ellie Link](https://ellie-app.com/cJThH7q7Ja1/3)
...
## Add the Magic Eight Ball Markup [Ellie Link](https://ellie-app.com/cJThH7q7Ja1/4)
...
## Get Random Int in answer List [Ellie Link](https://ellie-app.com/cJThH7q7Ja1/5)
...
## Remove Dead Code with the Compiler [Ellie Link](https://ellie-app.com/cJThH7q7Ja1/6)
...
## Render New Responses with Better Animation [Ellie Link](https://ellie-app.com/cJThH7q7Ja1/9)
